...
fun <T> checkType(args: T): String {
    val result: String
    if (args is Int) result = "Yes! it's Integer"
    else if (args is String) result = "Yes! it's String"
    else if (args is Boolean) result = "Yes! it's Boolean"
    else if (args is Double) result = "Yes! it's Double"
    else if (args is List<*>) result = "Yes! it's List"
    else if (args is Map<*, *>) result = "Yes! it's Map"
    else result = "Cannot resolve"
    return result
}
